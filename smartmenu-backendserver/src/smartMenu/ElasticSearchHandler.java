...
/*
 * updated: search reviews add minimum match clause
 * updated: add max size return
 * 
 */
public class ElasticSearchHandler {
	...
	protected static JSONArray searchByQueryMatchObject(JSONObject queryMatchObject, String index, String term) throws JSONException {
		JSONObject queryObject = addMaxSize(generateQueryJSONByMatchJSON(queryMatchObject));
	...
	public static JSONArray searchByText(String queryString, String index, String term) throws JSONException{
		JSONObject queryMatchObject = addMaxSize(generateQueryMatchObject("text", queryString));
	...
	public static JSONObject generateQueryMatchObject(String...termsAndTexts) throws JSONException {
		...
		JSONObject bool = new JSONObject().put("should", should).put("minimum_should_match", ((Integer)(termsAndTexts.length / 2)).toString());
