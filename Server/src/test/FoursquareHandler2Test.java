...
public class FoursquareHandler2Test {
	...
	private static String sw = "40.63,-74.03";
	private static String ne = "40.65,-73.97";
	...
	public static void testGetRestaurantsByLocation() {
		System.out.println(FoursquareHandler2.getRestaurantsByLocation(lat + "," + lon).size());
	}
	
	public static void testGetRestaurantsByBounds(){
		System.out.println(FoursquareHandler2.getRestaurantsByBounds(sw, ne).size());
	}
